...
class TrainedMNISTTeachers(_BaseTeachers):
    ...
    def _setup_teachers(self, config: Parameters):
        ...
        if not os.path.exists(saved_weights_path):
            ...
            print("Teachers with given config do not have associated saved \
            ...
            for t in range(self._num_teachers):
                ...
                mnist_classifier.save_model_weights(
                    path=os.path.join(saved_weights_path, "teacher_{}.pt".format(t)))

            print("Teachers with config {} trained and \
        ...
        for t in range(self._num_teachers):
            ...
            teacher.load_weights(
                weights_path=os.path.join(saved_weights_path, "teacher_{}.pt".format(t)))
