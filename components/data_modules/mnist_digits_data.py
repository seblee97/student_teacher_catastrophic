...
class MNISTDigitsData(_MNISTData):
    ...
    def _generate_dataloaders(self) -> None:
        ...
        for t, task_classes in enumerate(self._mnist_teacher_classes):
            ...
            train_task_dataset: ConcatDataset = ConcatDataset(train_target_filtered_datasets)
            ...
            test_task_dataset: ConcatDataset = ConcatDataset(test_target_filtered_datasets)
