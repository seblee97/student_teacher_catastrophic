...
tmux send-keys -t schedule_1 "python main.py -config configs/regression/relu_relu_big/base_config.yaml --ac additional_configs/  --en regression_relu_relu_big" C-m
tmux send-keys -t schedule_2 "python main.py -config configs/regression/relu_relu_small/base_config.yaml --ac additional_configs/ --en regression_relu_relu_small" C-m
tmux send-keys -t schedule_3 "python main.py -config configs/regression/relu_sigmoid_big/base_config.yaml --ac additional_configs/ --en regression_relu_sigmoid_big" C-m
tmux send-keys -t schedule_4 "python main.py -config configs/regression/relu_sigmoid_small/base_config.yaml --ac additional_configs/ --en regression_relu_sigmoid_small" C-m
tmux send-keys -t schedule_5 "python main.py -config configs/regression/sigmoid_relu_big/base_config.yaml --ac additional_configs/ --en regression_sigmoid_relu_big" C-m
tmux send-keys -t schedule_6 "python main.py -config configs/regression/sigmoid_relu_small/base_config.yaml --ac additional_configs/ --en regression_sigmoid_relu_small" C-m
tmux send-keys -t schedule_7 "python main.py -config configs/regression/sigmoid_sigmoid_big/base_config.yaml --ac additional_configs/ --en regression_sigmoid_sigmoid_big" C-m
tmux send-keys -t schedule_8 "python main.py -config configs/regression/sigmoid_sigmoid_small/base_config.yaml --ac additional_configs/ --en regression_sigmoid_sigmoid_small" C-m
