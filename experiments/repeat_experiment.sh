...
tmux send-keys -t seed_5 "python main.py --lc continual --tc overlapping --sc fixed_period --ts 100000 --v 1 --nl linear --to '[50, 0]' --s 5 --en seed5" C-m
tmux send-keys -t seed_10 "python main.py --lc continual --tc overlapping --sc fixed_period --ts 100000 --v 1 --nl linear --to '[50, 0]' --s 10 --en seed10" C-m
tmux send-keys -t seed_15 "python main.py --lc continual --tc overlapping --sc fixed_period --ts 100000 --v 1 --nl linear --to '[50, 0]' --s 15 --en seed15" C-m
tmux send-keys -t seed_20 "python main.py --lc continual --tc overlapping --sc fixed_period --ts 100000 --v 1 --nl linear --to '[50, 0]' --s 20 --en seed20" C-m
tmux send-keys -t seed_25 "python main.py --lc continual --tc overlapping --sc fixed_period --ts 100000 --v 1 --nl linear --to '[50, 0]' --s 25 --en seed25" C-m
