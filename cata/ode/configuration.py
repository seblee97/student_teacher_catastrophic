...
from cata.ode.overlaps import CrossOverlap
from cata.ode.overlaps import SelfOverlap
...
class StudentTwoTeacherConfiguration:
    ...
    def configuration(self) -> network_configuration.NetworkConfiguration:
        ...
        if self._consolidation:
            config_arg_dict["old_student_self_overlap"] = self._Q__.values
            config_arg_dict["student_old_student_overlap"] = self._Q_.values
            config_arg_dict["teacher_old_student_overlaps"] = [
                self._R_.values,
                self._U_.values,
            ]
        else:
            config_arg_dict["old_student_self_overlap"] = []
            config_arg_dict["student_old_student_overlap"] = []
            config_arg_dict["teacher_old_student_overlaps"] = []
        return network_configuration.NetworkConfiguration(**config_arg_dict)
