...
class BasePlotter(abc.ABC):
    ...
    ERROR_IDENTIFIERS = {
        constants.GENERALISATION_ERROR: constants.GENERALISATION_ERROR_LABEL,
        constants.LOG_GENERALISATION_ERROR: constants.LOG_GENERALISATION_ERROR_LABEL,
    }

    OVERLAP_IDENTIFIERS = {
        constants.STUDENT_HEAD: constants.STUDENT_HEAD_LABEL,
        constants.STUDENT_SELF: constants.STUDENT_SELF_LABEL,
        constants.STUDENT_TEACHER_0: constants.STUDENT_TEACHER_0_LABEL,
        constants.STUDENT_TEACHER_1: constants.STUDENT_TEACHER_1_LABEL,
        constants.STUDENT_OLD_STUDENT: constants.STUDENT_OLD_STUDENT_LABEL,
    }

    OTHER_IDENTIFIERS = {constants.TEACHER_INDEX: constants.TEACHER_INDEX}
    ...
    def _collate_tags(self, tags: List[str]) -> Dict[str, List[str]]:
        ...
        constants.GENERALISATION_ERROR, and are followed by an index.
    ...
    def _plot_scalar(
        ...
        for data_type, data in data_collection.items():
            if data_type == constants.ODE:
                linestyle = constants.SOLID
            elif data_type == constants.SIM:
                linestyle = constants.DASHED
        ...
        # labelling
        fig_sub.set_xlabel(constants.STEP)
